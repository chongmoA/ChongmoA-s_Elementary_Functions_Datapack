...
execute if score input elem_temp matches 1571.. run function elementary_function:tools/tan_mirror

execute store result storage elementary:pointer pointer int 1 run scoreboard players get input elem_temp
execute store result score result elementary_function run function elementary_function:tools/lookups/tan with storage elementary:pointer
