...
execute if score input elem_temp matches 1800.. run scoreboard players remove input elem_temp 1800

scoreboard players set flag_neg_2 elem_temp 0
execute if score input elem_temp matches 901.. run function elementary_function:tools/tan_mirror_deg

execute store result storage elementary:pointer pointer int 1 run scoreboard players get input elem_temp
execute store result score result elementary_function run function elementary_function:tools/lookups/tan_deg with storage elementary:pointer
